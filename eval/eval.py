...
def parse_arguments(parser):
    parser.add_argument('--gold_file', type=str, default="data/ECOB-ZH/baseline4796_328_提交8_team_g9OrQLtH.ann.json")
    parser.add_argument('--pred_file', type=str, default='data/ECOB-ZH/team_g9OrQLtH.ann.json')
